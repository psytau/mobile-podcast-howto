...
* set up mail for devise confirmations
  ...
  * add host for mailer eg: config.action_mailer.default_url_options = { :host => 'localhost' } in dev and production
* fix problems by turning debugging on in production.
